	...
	render() {
		return (
			<SafeAreaView style={styles.container}>
				<PaperDrawer.Section>
					<Title style={styles.title}>Just A Chat App</Title>
				</PaperDrawer.Section>
				<PaperDrawer.Section style={styles.navigationSection}>
					<PaperDrawer.Item
						style={styles.item}
						label="Chats"
					...
					<PaperDrawer.Item
						...
						style={styles.item}
					/>
					<PaperDrawer.Item label="Logout" onPress={() => this.handleLogout()} style={styles.item} />
				</PaperDrawer.Section>
				<PaperDrawer.Section style={styles.closeSection}>
					<IconButton
						icon="close"
						size={30}
